...
{%- set default_source_url   = 'http://10.200.1.113/java-dependencies/jdk-8u74-linux-x64.tar.gz' %}
{%- set default_jce_url      = 'http://10.200.1.113/java-dependencies/jce_policy-8.zip' %}
